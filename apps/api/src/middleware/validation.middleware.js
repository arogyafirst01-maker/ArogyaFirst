...
const { validateEmail, validatePassword, validatePhone, validateAadhaarLast4, validateDateFormat, PAYMENT_METHODS, validateDocumentType, validateConsentStatus, DOCUMENT_TYPES, CONSENT_STATUS, SHIFT_TYPES, SCHEDULE_STATUS, HEALTH_ARTICLE_CATEGORIES, MEDICAL_HISTORY_TYPES, INVOICE_STATUS, INVOICE_ITEM_TYPE, TAX_TYPES, PO_STATUS, CONTACT_SUBJECTS, TEMPLATE_CATEGORIES, BED_TYPES } = require('@arogyafirst/shared');
const { validationErrorResponse } = require('../utils/response.util.js');
...
module.exports = { validate, validateRequest, registerPatientSchema, registerHospitalSchema, registerDoctorSchema, registerLabSchema, registerPharmacySchema, loginSchema, createSlotSchema, updateSlotSchema, createBookingSchema, manualBookingSchema, updateBookingStatusSchema, cancelBookingSchema, createOrderSchema, verifyPaymentSchema, addSlotSchema, addDoctorSchema, addLabSchema, addBedSchema, addPharmacySchema, addStaffSchema, updateDoctorSchema, updateLabSchema, updateBedSchema, updatePharmacySchema, updateStaffSchema, addQCRecordSchema, updateQCRecordSchema, documentUploadSchema, getPatientDocumentsSchema, updateDocumentSchema, bulkUploadReportsSchema, bulkUploadMedicinesSchema, addSupplierSchema, updateSupplierSchema, createPurchaseOrderSchema, updatePurchaseOrderSchema, approvePurchaseOrderSchema, receivePurchaseOrderSchema, requestConsentSchema, approveConsentSchema, rejectConsentSchema, checkConsentSchema, getPatientConsentsSchema, getProviderConsentsSchema, createPrescriptionSchema, prebookPrescriptionSchema, cancelPrescriptionSchema, searchMedicinesSchema, createPharmacyLinkSchema, createReferralSchema, acceptReferralSchema, rejectReferralSchema, cancelReferralSchema, createStaffScheduleSchema, updateStaffScheduleSchema, getAnalyticsQuerySchema, getMedicalHistorySchema, exportMedicalHistorySchema, getHealthArticlesSchema, createConsultationSchema, updateConsultationStatusSchema, addConsultationNoteSchema, saveChatMessageSchema, getConsultationsSchema, getDoctorPatientsSchema, generateInvoiceSchema, updateInvoiceStatusSchema, markInvoiceAsPaidSchema, cancelInvoiceSchema, sendEmailOTPSchema, verifyEmailOTPSchema, forgotPasswordSchema, verifyPhoneOTPSchema, resetPasswordSchema, rescheduleBookingSchema, stockAdjustmentSchema, physicalVerificationSchema, contactFormSchema, addPrescriptionTemplateSchema, updatePrescriptionTemplateSchema, getPrescriptionTemplatesSchema, deletePrescriptionTemplateSchema, addLocationSchema, updateLocationSchema, getQueueQuerySchema, addToQueueSchema, allocateBedSchema, releaseBedSchema, removeFromQueueSchema, getAvailableBedsQuerySchema };
